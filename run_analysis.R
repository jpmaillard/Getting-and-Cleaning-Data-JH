...
# The needed packages are: dplyr, data.table, tidyr
...
# a. We check if we have these required package on our machine
...
# b. We check for the existence of the folder we will download the data sets.

if(!file.exists("./Assignemts")){dir.create("./Assignments")}

# c. We need to change our workding directory to the files directory

setwd("./Assignments")


# d. We download and unzip the set of data sets
